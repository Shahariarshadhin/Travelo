    ...
    return (
        <div className='home'>
            ...
            <div className='extra-sec'>
                ...
                <div>
                    <iframe width="700" height="315" src="https://www.youtube.com/embed/1heeXKUAFyA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <Footer></Footer>
